...
<html lang="en">
  <head>
    ...
    <title>IOT VFT</title>
    <!-- CSS files -->
    <link href="./dist/css/tabler.min.css?v=150" rel="stylesheet"/>
      ...
      <header class="navbar navbar-expand-md navbar-light d-print-none">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="home.php">
            <img src="./static/logoVFT.svg" width="auto" height="32" alt="Tabler" class="navbar-brand-image">
                        </a>
                                    <a href="home.php">
            <span id="status" class="lead" >Desconectado</span>
                        </a>
          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item d-none d-md-flex me-3">
              <div class="btn-list">
                ...
                <a href="https://github.com/tabler/tabler" class="btn btn-outline-white" target="_blank" rel="noreferrer">Cerrar Sesión
...
<div class="brand" style="float: right; margin-right: 15px;">
  ...
  <input type="hidden" name="extra_submit_param" value="extra_submit_value">
                    ...
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/file-text -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M24 22h-20v-7h2v5h16v-16h-16v5h-2v-7h20v20zm-13-11v-4l6 5-6 5v-4h-11v-2h11z"/></svg>
                    </span>
                    <span class="nav-link-title">
  <button type="submit" name="logout" value="submit_value" class="link-button" style="font-family: var(--tblr-font-sans-serif);color:currentcolor;background:none!important;border:none;padding:0!important;">
    Cerrar Sesion
  </button>
                    </span>
                  </a>
...
-->
              <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                  <li class="list-inline-item">
                    Copyright &copy; 2021
                    <a href="." class="link-secondary">Vector Fields Technologies - </a>Todos los derechos reservados.
                  </li>
				  	<!-- 
                  <li class="list-inline-item">
